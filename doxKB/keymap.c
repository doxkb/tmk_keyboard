...
#define KEYMAP( \
	R0C4,	R1C4,	R2C4,	R3C4,	R4C4,	R5C4,	R6C4,	R7C4,	R8C4,	R9C4,	R10C4,	R11C2,	R12C3,	R13C4,	R13C5,\
	R0C3,	R1C3,	R2C3,	R3C3,	R4C3,	R5C3,	R6C3,	R7C3,	R8C3,	R9C3,	R10C3,	R11C1,	R12C2,	R13C3,	\
	R0C2,	R1C2,	R2C2,	R3C2,	R4C2,	R5C2,	R6C2,	R7C2,	R8C2,	R9C2,	R10C2,	R11C0,			R13C2,	\
	R0C1,	R1C1,	R2C1,	R3C1,	R4C1,	R5C1,	R6C1,	R7C1,	R8C1,	R9C1,	R10C1,			R12C1,	R13C1,	\
	R0C0,	R1C0,	R2C0,				 	R5C0,							R9C0,	R10C0,			R12C0,	R13C0	\
) { \
	{ KB_NO,	R0C0,	R0C1,	R0C2,	R0C3,	R0C4 }, \
	...
	{ R12C0,	R12C1,	KB_NO,	R12C2,	R12C3,	KB_NO }, \
	{ R13C0,	R13C1,	R13C2,	R13C3,	R13C4,	R13C5 } \
}
...
static const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KEYMAP(KB_ESC, KB_F1,  KB_F2,  KB_F3,  KB_F4,  KB_F5,  KB_F6,  KB_F7,  KB_F8,  KB_F9,  KB_F10, KB_F11, KB_F12, KB_INS, KB_DEL, \
           ...
           KB_NO,  KB_LGUI,KB_LALT,KB_SPC, KB_RALT,KB_NO,  KB_RCTL,  KB_DEL),
     ...
     * `-----------------------------------------------------------'
     */
    KEYMAP(KB_MINS,KB_0,   KB_9,   KB_8,   KB_7,   KB_6,   KB_5,   KB_4,   KB_3,   KB_2,   KB_1,   KB_NO,  KB_NO,  KB_ESC, KB_GRV, \
